...
import org.spv.Engine;
import org.spv.IOUtil;
import org.spv.accelerator.CacheContext;
import org.spv.accelerator.CacheableResource;
import org.spv.json.JSONUtil;
import org.spv.model.ITemplate;

@SuppressWarnings("serial")
public class SpindleViewServlet extends HttpServlet {
	...
	public void init(ServletConfig cfg) {
		try {
			...
			if (ctx.getInitParameter("spv-dev-mode") != null) {
				isDevMode = ("true".equals(ctx.getInitParameter(
						"spv-dev-mode").toLowerCase()));
			}

			if (ctx.getInitParameter("spv-templates") != null) {
				String tString = ctx.getInitParameter("spv-templates");
