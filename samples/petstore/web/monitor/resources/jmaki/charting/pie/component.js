jmaki.namespace("jmaki.widgets.jmaki.charting.pie");

jmaki.widgets.jmaki.charting.pie.Widget = function(wargs) {
  ...
  function showDataFormatError() {
    ...
    this.prototype.publish = "/jmaki/charting/pie";
    this.prototype.subscribe = ["/jmaki/charting/pie", "/chart"]; 
